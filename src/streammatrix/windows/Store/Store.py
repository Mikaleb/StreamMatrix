...
from src.streammatrix.backend.DeckManagement.HelperMethods import is_video
from src.streammatrix.windows.Store.SDPlusBarWallpapers.SDPlusBarWallpaperPage import SDPlusBarWallpaperPage
...
if TYPE_CHECKING:
    from src.streammatrix.windows.mainWindow.mainWindow import MainWindow

# Import globals
import globals as gl

# Import own modules
from src.streammatrix.backend.DeckManagement.ImageHelpers import image2pixbuf
from src.streammatrix.windows.Store.Plugins.PluginPage import PluginPage
from src.streammatrix.windows.Store.Icons.IconPage import IconPage
from src.streammatrix.windows.Store.StorePage import StorePage
from src.streammatrix.windows.Store.Wallpapers.WallpaperPage import WallpaperPage

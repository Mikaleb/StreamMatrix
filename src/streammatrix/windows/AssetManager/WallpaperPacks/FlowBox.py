...
if TYPE_CHECKING:
    from src.streammatrix.windows.AssetManager.WallpaperPacks.PackChooser import WallpaperPackChooser
    from src.streammatrix.windows.AssetManager.WallpaperPacks.Preview import WallpaperPackPreview

...
if TYPE_CHECKING:
    from src.streammatrix.windows.AssetManager.IconPacks.PackChooser import IconPackChooser
    from src.streammatrix.backend.IconPackManagement.Icon import Icon

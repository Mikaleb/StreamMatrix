...
if TYPE_CHECKING:
    from src.streammatrix.backend.DeckManagement.DeckController import ControllerDial, ControllerTouchScreen
...
from typing import TYPE_CHECKING
if TYPE_CHECKING:
    from src.streammatrix.windows.mainWindow.elements.PageSettingsPage import PageSettingsPage

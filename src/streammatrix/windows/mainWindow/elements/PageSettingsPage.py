...
# Import own modules
from src.streammatrix.windows.mainWindow.elements.DeckConfig import DeckConfig
...
if TYPE_CHECKING:
    from src.streammatrix.windows.mainWindow.elements.DeckStack import DeckStackChild

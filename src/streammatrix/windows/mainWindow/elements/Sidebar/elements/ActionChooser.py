...
from src.streammatrix.backend.PluginManager.ActionHolderGroup import ActionHolderGroup
from src.streammatrix.backend.PluginManager.ActionInputSupport import ActionInputSupport
...
# Import own modules
from src.streammatrix.backend.DeckManagement.HelperMethods import get_last_dir
...
if TYPE_CHECKING:
    from src.streammatrix.windows.mainWindow.elements.Sidebar import Sidebar

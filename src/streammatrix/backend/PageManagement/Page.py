...
from src.streammatrix.backend.DeckManagement.ImageHelpers import crop_key_image_from_deck_sized_image
import globals as gl
...
if TYPE_CHECKING:
    from src.streammatrix.backend.DeckManagement.DeckController import LabelManager
    from src.streammatrix.backend.PluginManager.ActionHolder import ActionHolder
    from src.streammatrix.backend.DeckManagement.DeckController import ControllerKeyState, ControllerKey
...
class Page:
    ...
    def load_action_objects(self):
        ...
        for input_type in Input.All:
            input_class = getattr(sys.modules["src.streammatrix.backend.DeckManagement.DeckController"], input_type.controller_class_name)

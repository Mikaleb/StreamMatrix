...
from src.streammatrix.backend.DeckManagement.InputIdentifier import Input, InputEvent
...
if TYPE_CHECKING:
    ...
    from src.streammatrix.backend.DeckManagement.InputIdentifier import InputIdentifier
